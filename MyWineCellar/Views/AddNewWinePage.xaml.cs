...
namespace MyWineCellar.Views
{
    internal sealed partial class AddNewWinePage : Page
    {
        ...
        private void SetBehaviorsForProducerTextBox()
        {
            Interaction.SetBehaviors(this.TextBoxProducer, new BehaviorCollection
            {
        ...
        private void SetBehaviorsForCountryTextBox()
        {
            Interaction.SetBehaviors(this.TextBoxCountry, new BehaviorCollection
            {
                new EventTriggerBehavior
                {
                    EventName = "LostFocus",
